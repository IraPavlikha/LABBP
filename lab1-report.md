...
**Скріншот:** структура папок проєкту в середовищі розробки  
**Підпис:** *Рисунок 1 – Структура папок серверної частини проєкту*
...
**Скріншот:** вміст файлу `.env`  
**Підпис:** *Рисунок 2 – Файл змінних середовища .env*
...
API реалізоване за принципами REST. Сервер надає маршрути для створення та отримання аукціонів, подання ставок і керування користувачами. Усі маршрути протестовані за допомогою Postman.

**Скріншот:** тестування GET-запиту списку аукціонів у Postman  
**Підпис:** *Рисунок 3 – Отримання списку активних аукціонів*

**Скріншот:** тестування POST-запиту створення нового лоту  
**Підпис:** *Рисунок 4 – Створення нового аукціону через API*
